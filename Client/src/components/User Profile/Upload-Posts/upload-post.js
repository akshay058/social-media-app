      ...
      <form className="Upload-Post-Wrapper">
        <div className="Header-upload">
          ...
          <div className="Header-Upload-right">
            <span className="material-symbols-outlined" onClick={props.close}>
              cancel
            </span>
          </div>
        </div>
        ...
        <div className="Profile-Upload-Section">
          <div
            ...
            style={{
              backgroundImage: `url(images/${"linkedIn.jpg"})`,
        ...
        <div className="Main-Post-Section">
          ...
          <div className="Main-Post-Outer-Wrapper">
            {/* <div
              ...
              style={{
                backgroundImage: `url(${Image.RenderImage})`,
